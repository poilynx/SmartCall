...
7. 引入LruCache内存缓存，在首字母频繁滚动时，还能保持流畅的使用体验，具体看下图，绝大多时候，都是在绿线以下的（绿线代表流畅）。  
![经过优化后的fps](http://git.oschina.net/uploads/images/2015/0717/144323_0fa4c38a_331643.png "经过优化后的fps")
